import { c as create_ssr_component } from "./index-6db6ab93.js";
import "firebase/auth";
const Music = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${""}"><audio controls style="${"margin-top: 2%;"}"><source src="${"https://coderadio-admin.freecodecamp.org/radio/8010/radio.mp3"}" type="${"audio/mpeg"}"></audio></div>`;
});
